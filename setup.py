...
setuptools.setup(
    ...
    url              = 'https://github.com/MuhdMujibRahman/Image-processing-architecture',
    author           = 'Hans Gaiser',
    ...
    install_requires = ['keras==2.13.1', 'keras-resnet', 'six', 'scipy', 'cython', 'Pillow', 'opencv-python', 'progressbar2'],
    entry_points     = {
        'console_scripts': [
